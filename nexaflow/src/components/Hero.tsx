  ...
  return (
    <section id="hero" className="relative w-full pt-36 pb-20 lg:pt-44 lg:pb-32 px-6 flex flex-col items-center justify-center overflow-hidden">
      ...
      <motion.div 
        ...
        className="absolute -top-12 -left-12 -right-12 -bottom-36 z-0 pointer-events-none"
        style={{
          backgroundImage: "url('https://res.cloudinary.com/xgii56lh/image/upload/v1789366517/nexflow.jpg_2K_20260914114442.jpg')",
          backgroundSize: 'cover',
          backgroundPosition: 'calc(50% + 140px) 38%',
          backgroundRepeat: 'no-repeat'
        }}
      />
      {/* Soft gradient overlay for text legibility while letting bottom flow extend */}
      <div className="absolute inset-0 bg-gradient-to-b from-white/30 via-white/50 to-white/80 z-0 pointer-events-none" />
