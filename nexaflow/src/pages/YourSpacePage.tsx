        ...
        >
          <div>
            ...
            <p className="text-lg text-slate-600 mb-3">
              Welcome back. Here is how your autonomous workflows are performing.
            </p>

            {/* Paid Scale Plan Subscription Badge */}
            <div className="flex flex-col sm:inline-flex sm:flex-row sm:flex-wrap items-center justify-center sm:justify-start text-center sm:text-left gap-2 sm:gap-2.5 p-2.5 sm:p-1.5 px-4 sm:px-3 rounded-2xl sm:rounded-full bg-slate-100/90 border border-slate-200/80 text-xs w-full sm:w-auto">
              <span className="inline-flex items-center justify-center gap-1.5 px-2.5 py-0.5 rounded-full bg-blue-900 text-white font-bold text-[11px] shadow-2xs text-center">
                <Sparkles className="w-3 h-3 text-blue-200 shrink-0" />
                <span>Scale Plan • Paid Annually</span>
              </span>
              ...
              <button
                ...
                className="font-semibold text-blue-900 hover:text-blue-950 underline cursor-pointer text-center sm:text-left"
              >
                Invoices & Quotas
              </button>
            </div>
                        ...
                        <button
                          onClick={() => {
                            toast.success('Enterprise Consultation Requested', { 
                              description: 'Your dedicated enterprise architect has been assigned and will reach out to your account email.' 
                            });
                            setActivePanel(null);
                          }}
